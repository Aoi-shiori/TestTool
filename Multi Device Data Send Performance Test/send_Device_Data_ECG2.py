...
def send():
    ...
    with ThreadPoolExecutor(max_workers=30) as t:
        while not q.empty():
                ...
                #     # print("*"*50)
                #     pass
                # L1=list(map(lambda ecg,recordTime,token:[ecg,recordTime,token]),ecg,recordTime,token)
                # print("测试列表："+L1)
...
if __name__ == '__main__':
    ...
    ecg_count = 30
    # ECG设备号
    ECGPatch = "ECGRec_100000/C300000"
    # 要绑定的SpO2数量
    spo2_count =0
    # SpO2  设备号
    SpO2Patch = "O2 3000000000"
    # 要绑定的BP数量
    bp_count = 0
    # BP  设备号
    BPPatch = "BP5S_3000000000000"
    # 2023-11-24 15:00:00
    startTime = 1700809200000
    # 2023-11-24 17:00:00
    endTime = 1700816400000
